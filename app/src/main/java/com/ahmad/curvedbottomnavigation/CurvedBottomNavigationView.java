...
public class CurvedBottomNavigationView extends BottomNavigationView {
    ...
    public Point mFirstCurveEndtPoint = new Point();
    ...
    public Point mSecondCurveEndtPoint = new Point();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPath.cubicTo(mFirstCurveControlPoint1.x, mFirstCurveControlPoint1.y,
                ...
                mFirstCurveEndtPoint.x, mFirstCurveEndtPoint.y);

        mPath.cubicTo(mSecondCurveControlPoint1.x, mSecondCurveControlPoint1.y,
                mSecondCurveControlPoint2.x, mSecondCurveControlPoint2.y,
                mSecondCurveEndtPoint.x, mSecondCurveEndtPoint.y);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //the coordinates(x,y) of start point before curve
        mFirstCurveStartPoint.set((mNavigationBarWidth / 2) - (CURVE_CIRCLE_RADIUS * 2) - (CURVE_CIRCLE_RADIUS / 3), 0);

        //the coordinate(x,y) of the end point after curve
        mFirstCurveEndtPoint.set((mNavigationBarWidth / 2), CURVE_CIRCLE_RADIUS + (CURVE_CIRCLE_RADIUS / 4));

        //same for second curve
        mSecondCurveStartPoint = mFirstCurveEndtPoint;

        mSecondCurveEndtPoint.set((mNavigationBarWidth / 2) + (CURVE_CIRCLE_RADIUS * 2) + (CURVE_CIRCLE_RADIUS / 3), 0);
        ...
        mFirstCurveControlPoint2.set(mFirstCurveEndtPoint.x - (CURVE_CIRCLE_RADIUS * 2) + CURVE_CIRCLE_RADIUS, mFirstCurveEndtPoint.y);


        mSecondCurveControlPoint1.set(mSecondCurveStartPoint.x + (CURVE_CIRCLE_RADIUS * 2) - CURVE_CIRCLE_RADIUS, mSecondCurveStartPoint.y);
        mSecondCurveControlPoint2.set(mSecondCurveEndtPoint.x - (CURVE_CIRCLE_RADIUS + (CURVE_CIRCLE_RADIUS / 4)), mSecondCurveEndtPoint.y);
